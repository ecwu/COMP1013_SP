...
int main () {
	...
	if (englishLetter1 >= 97){// if the letter is the lower case letter, convert it into uppercase letter by minus 32 to it's ASCII code
	...
	if (englishLetter2 >= 97){// if the letter is the lower case letter, convert it into uppercase letter by minus 32 to it's ASCII code
